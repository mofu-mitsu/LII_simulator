...
const stages =[
        ...
        {
            id: "shooting", 
            title: "🎯 特別：感情防衛シューティング", 
            sitTitle: "湧き上がる『嬉しい』感情", 
            sitDesc: "何か良いことがあり、「嬉しい！」という感情(Fe/Fi)が湧き上がってきました。しかしあなたのTi-Niがそれを許しません。下から湧き上がる感情バブルをタップで撃ち落とし、論理で上書きしてください。",
            thoughts:[
                { text: "素直に喜べばいいのに、なぜか疑ってしまう。", icon: "fa-solid fa-brain" },
                { text: "喜んだ後に落とされるのが怖いのか？防衛本能だ。", icon: "fa-solid fa-shield-halved" }
            ]
        }
        ];
const logicBullets =[
    "ほんとに？",
    "嬉しいってそもそも、どの程度から『嬉しい』っていうの？",
    "今のこの感情って、一般的な『嬉しい』と言える？",
    "でもこんなこと思ったとしても、持続しないよ？",
    "嬉しい、『はず』なんだけどな…",
    "いずれ消えていくよ？",
    "期待値を上げすぎるのは非合理的だ。",
    "冷静に考えたら、大して喜ぶようなことじゃない。",
    "感情なんて定義できないから信用できない！",
    "こんなこと思うなんてどうかしてるんだ！"
];
// お邪魔キャラたちのデータ
